...
<html lang="en">
  ...
  <head>
    ...
    <title>Alamraya Sebar Barokah</title>
  ...
  <body id="page-top">
    ...
    <section class="bg-primary" id="contact">
      <div class="container">
        <div class="row">
          <div class="col-lg-8 mx-auto text-center">
            <h2 class="section-heading text-white">Hubungi Kami</h2>
            <hr class="dark my-4">
            <p class="text-white mb-5">CV. Alamraya Sebar Barokah berada di Jalan Gianyar I No.C3/19, Gn. Anyar, Kota SBY, Jawa Timur 60294</p>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-4 ml-auto text-center text-white">
            <i class="fas fa-phone fa-3x mb-3 sr-contact-1"></i>
            <p>Phone : 087853000080 / 081273000080</p>
          </div>
          <div class="col-lg-4 mr-auto text-center text-white">
            <i class="fas fa-envelope fa-3x mb-3 sr-contact-2"></i>
            <p>
              E-mail : <a href="mailto:Info@alamraya.co.id">Info@alamraya.co.id</a>
            </p>
          </div>
        </div>
      </div>
    </section>
     <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3957.167174800602!2d112.7839970141831!3d-7.335114574180901!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd7fab7e356fa6f%3A0xdb3120fddaf9924d!2sAlamraya+Sebar+Barokah!5e0!3m2!1sen!2sid!4v1536822222878" width="100%" height="450" frameborder="0" marginheight="0" marginwidth="0" style="border:0" allowfullscreen></iframe>
